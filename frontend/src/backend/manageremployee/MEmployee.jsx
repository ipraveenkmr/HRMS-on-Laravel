...
export default function Employee() {
  ...
  const downloadAadhaar = (event) => {
    console.log("Download Aadhaar: " + JSON.stringify(event));
    window.open(event);
  };

  const downloadPan = (event) => {
    console.log("Download Pan: " + JSON.stringify(event));
    window.open(event);
  };
  ...
  const addUser = () => {
    ...
    updateStJobTitle("");
    updateStComment("");
    updateStEndDate(new Date());
    updateStStartDate(new Date());
