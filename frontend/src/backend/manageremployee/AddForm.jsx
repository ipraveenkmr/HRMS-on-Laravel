...
export default function AddForm({ closeform, eventid }) {
  ...
  const st_department = useemployeeStore((state) => state.st_department_id);
  ...
  const employeeEditApi = async () => {
    ...
    await axios
      ...
      .then(function (response) {
        ...
        updateStDepartment(response.data[0].department);
        ...
        updateStBranch(response.data[0].branch);
        ...
        updateStRefernceDepartment(response.data[0].reference_department_id);
